...
%Input Data Width:	12
%LSB Truncated bits:12
%FIR Width (Full Calculation Width Before Output Width Adjust) :   24
%-----------------------------------------------------------------------------------------------------------

	%MegaWizard Scaled Coefficient Values
	function  output = highpass_mlab_mat (stimulation, output)
	coef_matrix=[40 30 0 -34 -51 -39 0 46 72 56 0 -73 -120 -102 0 170 361 511 568 511 361 170 0 -102 -120 -73 0 56 72 46 0 -39 -51 -34 0 30 40 ];
	INTER_FACTOR  = 1;
	DECI_FACTOR  = 1; 
	MSB_RM  = 0;
	MSB_TYPE  = 0;
