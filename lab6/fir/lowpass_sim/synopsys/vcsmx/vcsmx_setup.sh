...
# ACDS 13.1.1 166 win32 2014.04.24.18:04:37
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  vhdlan -xlrm "$QSYS_SIMDIR/lowpass_rtl.vhd"                                
  vhdlan -xlrm "$QSYS_SIMDIR/lowpass_ast.vhd"                                
  vhdlan -xlrm "$QSYS_SIMDIR/lowpass.vhd"                                    
  vhdlan -xlrm "$QSYS_SIMDIR/lowpass_tb.vhd"                                 
fi
