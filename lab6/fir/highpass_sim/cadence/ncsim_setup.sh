...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvhdl -v93 "$QSYS_SIMDIR/highpass_rtl.vhd"                               
  ncvhdl -v93 "$QSYS_SIMDIR/highpass_ast.vhd"                               
  ncvhdl -v93 "$QSYS_SIMDIR/highpass.vhd"                                   
  ncvhdl -v93 "$QSYS_SIMDIR/highpass_tb.vhd"                                
fi
