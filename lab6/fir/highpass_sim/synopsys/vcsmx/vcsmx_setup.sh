...
# ACDS 13.1.1 166 win32 2014.04.25.15:20:06
...
if [ $SKIP_FILE_COPY -eq 0 ]; then
  cp -f $QSYS_SIMDIR/highpass_rtl_u0_m0_wo0_cm0_lutmem.hex ./
fi
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  vhdlan -xlrm "$QSYS_SIMDIR/highpass_rtl.vhd"                               
  vhdlan -xlrm "$QSYS_SIMDIR/highpass_ast.vhd"                               
  vhdlan -xlrm "$QSYS_SIMDIR/highpass.vhd"                                   
  vhdlan -xlrm "$QSYS_SIMDIR/highpass_tb.vhd"                                
fi
