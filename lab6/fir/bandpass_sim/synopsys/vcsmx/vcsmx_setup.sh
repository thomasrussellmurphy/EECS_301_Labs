...
# ACDS 13.1.1 166 win32 2014.04.18.14:06:58
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  vhdlan -xlrm "$QSYS_SIMDIR/bandpass_rtl.vhd"                               
  vhdlan -xlrm "$QSYS_SIMDIR/bandpass_ast.vhd"                               
  vhdlan -xlrm "$QSYS_SIMDIR/bandpass.vhd"                                   
  vhdlan -xlrm "$QSYS_SIMDIR/bandpass_tb.vhd"                                
fi
