...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvhdl -v93 "$QSYS_SIMDIR/bandpass_rtl.vhd"                               
  ncvhdl -v93 "$QSYS_SIMDIR/bandpass_ast.vhd"                               
  ncvhdl -v93 "$QSYS_SIMDIR/bandpass.vhd"                                   
  ncvhdl -v93 "$QSYS_SIMDIR/bandpass_tb.vhd"                                
fi
